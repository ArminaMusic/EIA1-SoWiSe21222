...
(function (L08_2_GoldenerHerbst) {
    ...
    function handleLoad(_event) {
        ...
        drawSingleTree({ x: 300, y: -40 }, [{ x: 10, y: 30 }, { x: 35, y: -20 }, { x: 50, y: 25 }, { x: 40, y: 10 }], [60, 35, 50, 50], "#6e5141", "#3a5e3a");
        drawSingleTree({ x: 160, y: -70 }, [{ x: 10, y: 30 }, { x: 35, y: -20 }, { x: 50, y: 25 }, { x: 40, y: 10 }], [60, 35, 50, 50], "#6e5141", "#b3511b");
        drawSingleTree({ x: 60, y: 110 }, [{ x: 15, y: -2 }, { x: 37, y: 35 }, { x: 20, y: 55 }, { x: 20, y: 40 }], [60, 35, 50, 50], "#6b4f3f", "#b3851b");
        drawSquirrel();
        drawLeafRed();
        drawLeafOrange();
        drawLeafYellow();
